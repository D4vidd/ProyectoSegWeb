...
window.drupalTranslations = {"strings":{"":{"!tour_item of !total":"!tour_item de !total","Tray orientation changed to @orientation.":"La orientaci\u00f3n de la bandeja se ha cambiado a @orientation.","Tray @action.":"Bandeja @action.","ResponseText: !responseText":"ResponseText: !responseText","Debugging information follows.":"A continuaci\u00f3n se detalla la informaci\u00f3n de depuraci\u00f3n.","Path: !uri":"Ruta: !uri","StatusText: !statusText":"StatusText: !statusText","The toolbar cannot be set to a horizontal orientation when it is locked.":"La barra de herramientas no puede ser puesta en orientaci\u00f3n horizontal cuando esta bloqueada.","Tabbing is no longer constrained by the Contextual module.":"Tabulando (Tabbing) ya no se ver\u00e1 limitado por el m\u00f3dulo Contextual (Contextual).","Tray \u0022@tray\u0022 @action.":"Bandeja \u0022@tray\u0022 @action","Extend":"Ampliar","Vertical orientation":"Orientaci\u00f3n vertical","An AJAX HTTP error occurred.":"Hubo un error HTTP AJAX.","Please wait...":"Espere, por favor...","Open":"Abierta","Collapse":"Plegar","@action @title configuration options":"@action @title opciones de configuraci\u00f3n","An AJAX HTTP request terminated abnormally.":"Una solicitud HTTP de AJAX termin\u00f3 de manera anormal.","End tour":"Final del recorrido","Changed":"Modificado","HTTP Result Code: !status":"C\u00f3digo de Resultado HTTP: !status","closed":"cerrado","Next":"Siguiente","Tabbing is constrained to a set of @contextualsCount and the edit mode toggle.":"La tabulaci\u00f3n est\u00e1 restringida a un conjunto de @contextualsCount y al cambio a modo de edici\u00f3n.","The callback URL is not local and not trusted: !url":"La URL de callback (llamada) no es local y no es confiable: !url","opened":"abierto","Horizontal orientation":"Orientaci\u00f3n horizontal","@label":"@label","Close":"Cerrar","Home":"Inicio","@count contextual link\u0003@count contextual links":"@count enlace contextual\u0003@count enlaces contextuales","ReadyState: !readyState":"ReadyState: !readyState","Press the esc key to exit.":"Presionar tecla esc para salir.","CustomMessage: !customMessage":"CustomMessage: !customMessage","The response failed verification so will not be processed.":"La respuesta de verificaci\u00f3n fall\u00f3, por lo que no se procesar\u00e1."}},"pluralFormula":{"1":0,"default":1}};;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
